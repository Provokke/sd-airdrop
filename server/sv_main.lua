        ...
        for src, player in pairs(players) do
            ...
            if phoneNumber then
                local success, err = pcall(function()
                    exports['lb-phone']:SendMessage('EMERGENCY-ALERT', phoneNumber, 'GOVERNMENT ALERT: Unidentified package drop detected in your vicinity. Citizens are advised to maintain safe distance and report any suspicious activity to authorities immediately. Proceed with extreme caution.', {})
                end)
