...
-- Target Config
Config.TargetName = 'ox_target'  -- Fixed: Changed from qb-target to match actual implementation
...
Config.Cooldown = 30 -- Global Cooldown
...
Config.ItemDrops = {
    ...
    ["greenphone"] = {
        [1] = {name = "ifaks", description = "iFaks", amount = 20},
        [2] = {name = "oxy", description = "Oxy", amount = 30},
        [3] = {name = "armor", description = "Armor", amount = 15},
        [4] = {name = "key_weed", description = "Key A", amount = 1},
